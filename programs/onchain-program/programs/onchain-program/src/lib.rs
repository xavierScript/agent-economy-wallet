...
/// Agent Reputation Program
///
/// A minimal on-chain reputation system for the Agent Economy.
/// Tracks payment volume, transaction count, and unique buyers
/// for each merchant agent registered in the ecosystem.
///
/// PDAs are derived from `["merchant", merchant_pubkey]`.
#[program]
