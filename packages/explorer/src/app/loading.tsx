        ...
        <div className="stats-grid stats-grid-6">
          {[...Array(6)].map((_, i) => (
            <div key={i} className="stat-card">
              ...
              <div className="skeleton" style={{ height: "10px", width: "60px", marginTop: "8px" }} />
            </div>
          ))}
        </div>
      </section>
        ...
        <div className="dashboard-grid">
          ...
          <aside className="dashboard-sidebar">
            <div className="activity-feed">
              ...
              <div className="activity-feed-list" style={{ padding: "16px", display: "flex", flexDirection: "column", gap: "16px" }}>
                {[...Array(4)].map((_, i) => (
